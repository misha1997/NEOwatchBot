// Weather-page current-conditions block: the 4 now-cards (Kp gauge, solar
// wind, Bz, X-ray). Port of fillCurrent in space-weather.js. `d` is the
// /api/weather payload (null → placeholders). The storm alert itself now
// lives in the hero (see Weather.js) rather than here.
