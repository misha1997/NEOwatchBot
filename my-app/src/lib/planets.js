...
// language-neutral. `to` is the i18n route name (resolved to a language-prefixed
// path by LocalizedLink); `disabled` marks pages that aren't built yet
// (rendered as "soon" tiles instead of links).
//
...
export const PLANETS = [
  ...
  {
    key: "mars", labelKey: "nav.mars", to: "mars",
  ...
  {
    key: "jupiter", labelKey: "nav.jupiter", to: "jupiter",
