...
//
// `grad` is the SVG radial-gradient stop triple [hi, mid, lo] used for the
// planet disc on the hub card; `accent` is a representative CSS color.
export const PLANETS = [
  {
    key: "mercury", labelKey: "nav.mercury", to: "/planetarium/mercury",
    disabled: true, accent: "#9C948B",
